...
const stats = [
  ...
  },
  {
    label: "Total Courses",
    value: "500+",
    icon: <MenuBookTwoToneIcon color="primary" />,
  },
  {
  ...
  },
  {
    ...
    value: "45+",
    icon: <PublicTwoToneIcon color="primary" />,
  },
];
    ...
    <Box sx={{ bgcolor: "background.default" }}>
      ...
      <Box
        sx={{
          ...
          alignItems: "center",
          backgroundImage:
            "linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url(https://images.unsplash.com/photo-1524178232363-1fb28f74b573?q=80&w=2070&auto=format&fit=crop)",
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                ...
                >
                  <Box
                    sx={{ p: 1.5, borderRadius: "50%", bgcolor: "primary.50" }}
                  >
                    {stat.icon}
                  </Box>
                  <Typography
            ...
            {[
              {
                ...
                desc: "Every course is peer-reviewed and led by industry experts.",
                icon: <WorkspacePremiumTwoToneIcon sx={{ fontSize: 40 }} />,
              },
              {
                title: "Innovation",
                desc: "We use the latest technology to make learning interactive and fun.",
                icon: <EmojiObjectsTwoToneIcon sx={{ fontSize: 40 }} />,
              },
              {
                title: "Accessibility",
                desc: "Education that fits your schedule and budget, no matter where you are.",
                icon: <PublicTwoToneIcon sx={{ fontSize: 40 }} />,
              },
            ].map((value, index) => (
              <Grid
                size={{ xs: 12, md: 4 }}
      ...
      >
        <Container maxWidth="md">
          ...
          <Typography
            ...
            sx={{ mb: 5, opacity: 0.9 }}
          >
            Join over 15,000 students and start learning today with our
            expert-led courses.
          </Typography>
          <Button
            variant="contained"
